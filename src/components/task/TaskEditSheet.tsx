...
export const TaskEditSheet = ({
  ...
  return <Sheet open={!!selectedTask} onOpenChange={open => !open && setSelectedTask(null)}>
      <SheetContent>
        <SheetHeader>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid gap-2">
            ...
            <Textarea id="title" value={editedTitle} onChange={e => setEditedTitle(e.target.value)} className="min-h-[80px] w-full" placeholder="Type your task name here." />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <Select value={editedType} onValueChange={value => setEditedType(value as TaskType)}>
              <SelectTrigger className="w-full">
        ...
        <SheetFooter className="mt-auto">
          <Button variant="secondary" onClick={handleDeleteTask} className="mr-auto gap-2">
            <Trash2 className="h-4 w-4" />
            Delete
          </Button>
          <Button type="submit" variant="default" onClick={handleSaveTask}>
            Save changes
          </Button>
        </SheetFooter>
      </SheetContent>
