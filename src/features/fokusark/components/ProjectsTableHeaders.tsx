    ...
    <TooltipProvider delayDuration={200}>
      <TableHeader className="sticky top-0 z-40 bg-background">
        ...
        <TableRow>
          ...
          <HeaderCell width={85} className="bg-violet-50/50 text-right border-r-4 border-r-border" tooltip="Est. timer ift. Færdig% − Brugte timer prod. Hvor mange produktionstimer der reelt er tilbage baseret på nuværende færdiggørelsesgrad. Positivt = foran plan (grøn), negativt = bagud (rød).">Timer tilbage Prod</HeaderCell>
