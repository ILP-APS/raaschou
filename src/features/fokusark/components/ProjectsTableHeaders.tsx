    ...
    <TooltipProvider delayDuration={200}>
      <TableHeader className="sticky top-0 z-40 bg-background">
        ...
        <TableRow>
          ...
          <HeaderCell width={180} className="sticky z-30 bg-muted text-center" style={{ left: '430px', boxShadow: '1px 0 0 0 hsl(var(--border))' }} tooltip="Produktions-status fra e-regnskab (kategori).">Status</HeaderCell>
