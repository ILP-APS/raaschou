...
BEGIN
  ...
  v_H := (v_D - v_E - v_F) * s_projecting_share / s_projecting_hourly_rate;
...
BEGIN
  ...
  UPDATE projects SET
    ...
    hours_estimated_projecting = (COALESCE(offer_amount,0) - (COALESCE(assembly_amount,0) + COALESCE(manual_assembly_amount,0)) - (COALESCE(subcontractor_amount,0) + COALESCE(manual_subcontractor_amount,0))) * s_projecting_share / s_projecting_hourly_rate,
    hours_estimated_production = (
      ...
      (COALESCE(offer_amount,0) - (COALESCE(assembly_amount,0) + COALESCE(manual_assembly_amount,0)) - (COALESCE(subcontractor_amount,0) + COALESCE(manual_subcontractor_amount,0))) * s_projecting_share / s_projecting_hourly_rate
    ),
